...
export const memeTemplates: MemeTemplate[] = [
  ...
  {
    keyword: "套壳网站",
    template: "你为啥几下子就把网站做成这样啊🫢🧐 套壳网站不是这样😡❌️ 你应该先搞个蓝紫色调夜间模式🗣️ 提升我的红温程度😡😡😡 给我吐出一堆看似有用但全是 Bug 的代码🎁 然后在某个深夜让我对着报错屏幕发呆🎆🎉 还要我在神秘力量帮助下勉强修好😍😘 最后让我自己折腾个一整夜怎么部署啊🤨🤐 你怎么直接上来就网站部署了、 SEO都做了🫨🧐 套壳网站根本不是这样😡🤬 我不接受😡😡👿😈"
  }
];
