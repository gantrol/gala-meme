...
export const memeTemplates: MemeTemplate[] = [
  ...
  {
    keyword: "套壳网站",
    template: "你为啥几下子就把网站做成这样啊🫢🧐 套壳网站不是这样😡❌️ 你应该先搞个蓝紫色调夜间模式🗣️ 提升我的红温程度😡😡😡 给我吐出一堆代码看似有用但全是 Bug🎁 然后在某个深夜让我对着报错屏幕发呆🎆🎉 还要我在神秘力量帮助下勉强修好😍😘 最后让我自己折腾个一整晚怎么部署啊🤨🤐 你怎么直接上来就把 SEO 和界面全整到位了🫨🧐 套壳网站根本不是这样😡🤬 我不接受😡😡👿😈你为啥几下子就把网站做成这样啊🫢🧐 套壳网站不是这样😡❌️ 你应该先搞个蓝紫色调夜间模式🗣️ 提升我的红温程度😡😡😡 给我吐出一堆代码看似有用但全是 Bug🎁 然后在某个深夜让我对着报错屏幕发呆🎆🎉 还要我在神秘力量帮助下勉强修好😍😘 最后让我自己折腾个一整晚怎么部署啊🤨🤐 你怎么直接上来就把 SEO 和界面全整到位了🫨🧐 套壳网站根本不是这样😡🤬 我不接受😡😡👿😈"
  }
];
